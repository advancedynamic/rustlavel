...
LDAP for Rustlavel: bind, search, and authenticating a user against a directory.
...
```toml
[dependencies]
rustlavel = { version = "0.7", features = ["ldap"] }
```

## Documentation

- [API documentation](https://docs.rs/rustlavel-ldap)
