...
Rustlavel templating: Blade-inspired layouts, sections, and automatic escaping.
...
```toml
[dependencies]
rustlavel = { version = "0.7", features = ["view"] }
```

## Documentation

- [API documentation](https://docs.rs/rustlavel-view)
