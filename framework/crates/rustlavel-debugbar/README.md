...
A development overlay showing what the current request actually did: queries, cache, timing.
...
```toml
[dependencies]
rustlavel = { version = "0.7", features = ["debugbar"] }
```

## Documentation

- [API documentation](https://docs.rs/rustlavel-debugbar)
