...
Rustlavel authentication: sessions, argon2 hashing, CSRF, signed URLs, encryption.
...
```toml
[dependencies]
rustlavel = { version = "0.7", features = ["auth"] }
```

## Documentation

- [API documentation](https://docs.rs/rustlavel-auth)
